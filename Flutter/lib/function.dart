...
class Myfunc extends StatefulWidget {
  const Myfunc({Key? key}) : super(key: key);

  @override
  State<Myfunc> createState() => _MyHomeState();
}

class _MyHomeState extends State<Myfunc> {
  String? _filePath;
  String predicted = '';
  //String prediction = '';
  String groundtruth = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 113, 211, 233),
